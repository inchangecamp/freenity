    ...
    <div class="app-main">
        <nav class="navbar navbar__menu" id="primary-navbar">
            <div class="navbar-header">
                ...
                <div class="d-flex align-items-center" @click="go_home()" style="color:#000;position:relative;z-index:10;">
...
document.addEventListener("DOMContentLoaded", function(event) { 
	...
	if (langs) {
		document.getElementById("langs_create_hide").value = langs;
		document.getElementById("langs_create").innerHTML = langs;
	} else {
